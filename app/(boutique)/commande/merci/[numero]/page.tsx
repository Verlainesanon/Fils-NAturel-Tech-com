  ...
  return (
    <section className="sec">
      <div className="wrap" style={{ maxWidth: '52rem' }}>
        <span className="eyebrow">Commande {commande.numero}</span>
        <h1 className="sec-titre">Merci, c’est enregistré.</h1>
        ...
        <div className="card-l recap-commande">
        ...
        <div className="hero-actions" style={{ marginTop: '1.8rem' }}>
          <Link className="btn btn-solid" href="/boutique">
